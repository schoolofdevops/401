...
|---|---|---|
| [Module 1: AI Foundations](./module-01-foundations/README.mdx) | LLMs from an ops perspective — tokenization, context windows, inference pipeline using operational analogies | 90 min |
| [Module 2: Platform AI](./module-02-platform-ai/README.mdx) | AWS built-in AI features — GuardDuty, CodeGuru, DevOps Guru, Bedrock | 60 min |
| [Module 3: Platform → Custom Agents](./module-03-bridge/README.mdx) | Bridge from platform AI to custom agents — live Hermes demo | 45 min |
| [Module 4: Impact Assessment](./module-04-impact/README.mdx) | Structured framework for scoring and prioritizing your top 10 automation candidates | 60 min |

### Day 2: Structured Coding and IaC

| Module | Topic | Duration |
|---|---|---|
| [Module 5: Superpowers for IaC](./module-05-superpowers-iac/README.mdx) | TDD, verification, debugging, and code review applied to Helm charts and Terraform modules — the Superpowers workflow on real IaC projects | 90 min |
| [Module 6: AI Workflow Tools](./module-06-ai-workflow-tools/README.mdx) | GSD planning workflow, CLAUDE.md context engineering, cross-session memory, plan mode selection | 90 min |
| [Module 7: Agent Skills](./module-07-agent-skills/README.mdx) | SKILL.md authoring — encoding runbooks as machine-readable domain knowledge | 90 min |
| [Module 8: Tool Integration](./module-08-tool-integration/README.mdx) | Wiring agents to real infrastructure tools — AWS CLI, kubectl, Terraform, monitoring APIs | 60 min |

### Day 3: Agent Systems and Capstone

| Module | Topic | Duration |
|---|---|---|
| [Module 9: Design Patterns](./module-09-design-patterns/README.mdx) | Agent patterns — triage-and-delegate, noise reduction, change gating, cost guardian | 60 min |
| [Module 10: Domain Agent Build](./module-10-domain-agent/README.mdx) | Build a complete domain agent — three tracks (Track A: Database, Track B: FinOps, Track C: Kubernetes) | 120 min |
| [Module 11: Triggers and Automation](./module-11-triggers/README.mdx) | Event-driven agent invocation — CI/CD hooks, CloudWatch triggers, scheduled runs | 60 min |
| [Module 12: Fleet Management](./module-12-fleet/README.mdx) | Multi-agent systems — the fleet coordinator pattern, delegation loops, Morgan | 60 min |
| [Module 13: Governance and Safety](./module-13-governance/README.mdx) | L1–L4 governance levels, SOUL.md safety design, audit trails, production criteria | 60 min |
| [Module 14: Capstone](./module-14-capstone/README.mdx) | Present your agent and 30-day deployment plan | 60 min |
