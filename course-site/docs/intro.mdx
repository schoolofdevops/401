...
| [Module 11: Fleet Management](./module-11-fleet/README.mdx) | Multi-agent systems — the fleet coordinator pattern, delegation loops, Morgan | 60 min |
| [Module 12: Triggers and Automation](./module-12-triggers/README.mdx) | Event-driven agent invocation — CI/CD hooks, CloudWatch triggers, scheduled runs | 60 min |
