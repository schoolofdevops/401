...
4. **Profile-based agents transfer across environments:** Run `hermes profile create track-a`, copy `config.yaml`, `SOUL.md`, and the skills directory into `~/.hermes/profiles/track-a/`, then run immediately. No build step.
