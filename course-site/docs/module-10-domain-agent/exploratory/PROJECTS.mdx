...
| Multi-agent coordination (preview of Module 12) | Project 2 (cross-track incident) |
...
All three projects prepare you for Module 12 (fleet orchestration), where multiple agents coordinate on cross-domain incidents. Project 2 is a preview of exactly that capability.
