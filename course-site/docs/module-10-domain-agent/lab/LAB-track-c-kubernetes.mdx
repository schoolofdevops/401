...
This lab uses `anthropic/claude-haiku-4` (configured in config.yaml).
Expected cost: less than $0.05 per complete diagnostic run. If you encounter rate limit errors,
