...
If you encounter rate limit errors, wait 60 seconds and retry — or switch to an alternate provider
as documented in `course/setup/llm-access.md`.
:::
