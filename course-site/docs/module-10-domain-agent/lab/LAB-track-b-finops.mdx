---
id: module-10-lab-track-b
title: "Module 10 Lab: Build the FinOps Agent (Track B)"
sidebar_label: "Lab — Track B: FinOps"
sidebar_position: 2
---
...
:::info Cross-Domain Skill — This is Intentional
...
:::info How Track B Safety Works — Read Before Proceeding
...
:::warning Pitfall: Premature Closure
...
**Next:** Module 12 fleet lab uses Finley as the Track B specialist in a cross-domain incident response scenario.
