...
:::info Lab Location
The hands-on lab for this module lives in the **Hermes repository**. This is the primary build module of Day 3 — everything from Modules 7, 8, and 9 converges here into a working agent. Read the [Concepts](./reading/concepts.mdx) page first, choose your track, then open the Hermes lab guide.
:::
...
| **Track C: Kubernetes Health** | *(Consolidated into Module 8)* | *(See note below)* | *(See note below)* |

Tracks A and B produce the same type of artifact: a complete Hermes agent profile (SOUL.md + config.yaml + skills/) with simulated data for testing when real infrastructure is not available.

### Track C: Testing Consolidated into Module 8

:::info Track C learners — skip this module
**Track C learners:** Your testing lab has been consolidated into the [Module 8 "Build and Test Your Kubernetes Agent"](../module-08-tool-integration/lab/LAB-track-c-kubernetes.mdx) lab. That 90-minute lab combines tool wiring (formerly Module 8) with agent testing (formerly Module 10), eliminating redundant setup and giving you an immediate feedback loop: configure, test against clean cluster, inject failures, evaluate diagnostics — all in one session.

**This module (Module 10) is for Tracks A and B only.** Track C learners should proceed directly to [Module 11: Fleet Workflows](../module-11-fleet-workflows/README.mdx).
:::

**If you completed your Module 4 impact assessment** — choose the track closest to your capstone candidate (Track A or B for this module). You will extend this agent in Module 13 for your capstone.
...
- **Track C:** Not applicable — Track C testing is now part of [Module 8 consolidated lab](../module-08-tool-integration/lab/LAB-track-c-kubernetes.mdx)

## Module Contents

| Section | Content | Time |
|---------|---------|------|
| Reading | [Concepts: Agent Anatomy and Build Strategy](./reading/concepts.mdx) | 20 min |
| Reading | [Reference: Agent Profile Structure and Output Evaluation](./reading/reference.mdx) | 10 min |
| Lab | Build Your Domain Agent — Track A or B (Hermes repo). Track C: see Module 8 | 80 min |
| Quiz | [Module 10 Assessment](./quiz/QUIZ.mdx) | 10 min |
