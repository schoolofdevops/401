...
:::info Lab Location
The hands-on lab for this module lives in the **Hermes repository**. Read the [Concepts](./reading/module-08-concepts) page first to understand the three tool integration patterns and why safety boundaries are non-negotiable. Then open the Hermes lab guide to wire your agent.
:::
...
|---------|---------|------|
| Reading | [Concepts: Tool Types, MCP, and Safety](./reading/module-08-concepts) | 15 min |
| Reading | [Reference: Tool Configuration and Safety Setup](./reading/module-08-reference) | 10 min |
| Lab | Configure Tools and Safety Boundaries (Hermes repo) | 25 min |
| Quiz | [Module 8 Assessment](./quiz/module-08-quiz) | 10 min |
| Exploratory | [Stretch Projects](./exploratory/module-08-exploratory) | Optional |
