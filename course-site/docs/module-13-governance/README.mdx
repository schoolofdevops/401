...
:::info Lab Location
The hands-on lab for this module lives in the **Hermes repository**. This is the final technical module before the capstone. Read the [Concepts](./reading/module-13-concepts) page to understand the governance triad and maturity levels — the lab builds on both. Then open the Hermes lab guide.
:::
...
|---------|---------|------|
| Reading | [Concepts: Governance Triad and Maturity Levels](./reading/module-13-concepts) | 15 min |
| Reading | [Reference: Governance Config Templates and Audit Logs](./reading/module-13-reference) | 10 min |
| Lab | Add Governance Layer to Your Agent (Hermes repo) | 25 min |
| Quiz | [Module 13 Assessment](./quiz/module-13-quiz) | 10 min |
| Exploratory | [Stretch Projects](./exploratory/module-13-exploratory) | Optional |
