...
|---------|---------|------|
| Lab | [Automation Quadrant Scoring Template](./lab/LAB.mdx) | 40 min |
| Reading | [Evaluating Automation Candidates](./reading/concepts.mdx) | 15 min |
| Quiz | [Module 4 Assessment](./quiz/QUIZ.mdx) | 5 min |
