...
:::info Lab Location
The hands-on lab for this module lives in the **Hermes repository**. Read the [Concepts](./reading/concepts.mdx) page to understand the four interface patterns and why each serves a different operational need. Then open the Hermes lab guide to configure cron schedules and webhooks.
:::
