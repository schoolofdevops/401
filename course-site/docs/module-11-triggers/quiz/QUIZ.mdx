...
**Reference:** The `release` label requirement is documented in Module 12 Step 9 (AlertManager setup). Verify with: `kubectl get prometheusrule -n monitoring hermes-lab-rules -o yaml | yq '.metadata.labels'`.
