...
- Install Superpowers using the [instructions here](https://github.com/obra/superpowers)
---
...
## How to Build this project (Non Negotiable)
You must use superpowers to build this using following steps/features
...
## Superpoers Starting Prompt 

Use this prompt 

```
I want you to read Claude.md and start building the project. I want you to use superpowers and use that to
the maximum of its capabilities, and start building this Terraform module for me.
```
...
The following prompts are optional, just to demonstrate how you would build this similar to useing super powers. 
