...
|-------|---------------|----------|
| **[Track A: Helm Chart](./lab/LAB-track-a-helm.mdx)** | Production Helm chart additions (HPA, PDB, ServiceMonitor, resource limits, NOTES.txt) for the reference app — generated from scratch via Superpowers | Kubernetes and platform engineers |
| **[Track B: Terraform](./lab/LAB-track-b-terraform.mdx)** | Complete Terraform EC2 + CloudWatch + SNS module — built from zero using TDD with mock_provider | Cloud and IaC engineers |
