...
- KIND cluster running with Prometheus and Grafana deployed (from Module 5a setup)
...
This is the centerpiece of Module 5b. You will run the complete GSD cycle — new-project, discuss, plan, execute, verify — on a well-scoped infrastructure task. By the end, you'll have production monitoring artifacts built by an AI that understood your system constraints.
...
- Module 5b Exploratory: Superpowers — TDD, systematic debugging, code review with AI assistance (optional, for participants who want to go deeper)
- Module 6: AI-Assisted IaC — Terraform (Track A) or ArgoCD GitOps (Track B)
