---
id: module-12-readme
title: "Module 12: Fleet Orchestration"
sidebar_label: "Overview"
sidebar_position: 0
---

# Module 12: Fleet Orchestration

**Duration:** 60 minutes
**Day:** Day 3, Session 6

:::info Lab Location
The hands-on lab for this module lives in the **Hermes repository**. The lab is designed as a team exercise for the live workshop. See the Solo Learner callout below if you are completing this course independently. Read the [Concepts](./reading/concepts.mdx) page first, then open the Hermes lab guide.
:::
...
- Module 11 completed (you have trigger infrastructure — AlertManager, CronJob)
...
|---------|---------|------|
| Reading | [Concepts: Fleet Patterns and Delegation](./reading/concepts.mdx) | 15 min |
| Reading | [Reference: Fleet Configuration and Coordinator Templates](./reading/reference.mdx) | 10 min |
| Lab | Fleet Orchestration — Team Exercise (Hermes repo) | 25 min |
| Quiz | [Module 12 Assessment](./quiz/QUIZ.mdx) | 10 min |
