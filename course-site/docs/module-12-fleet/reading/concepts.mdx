...
For the Module 12 lab, three specialists (DB, FinOps, K8s — one per Module 10 track) is the target fleet size. This is sufficient to demonstrate fleet orchestration without the synthesis complexity of larger fleets.
...
**Next:** [Reference — Fleet Configuration and Coordinator Templates](./reference.mdx)
