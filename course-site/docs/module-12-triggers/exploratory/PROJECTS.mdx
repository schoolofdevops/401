...
sidebar_position: 1
description: "Stretch projects for Module 12 — multi-trigger workflow and alert-to-agent pipeline"
---
...
**Estimated time:** 45 minutes
**Extends:** Module 12 lab (webhook configuration)
