---
id: module-07-lab
title: "Module 7 Lab: Write a Domain-Specific SKILL.md"
sidebar_label: "Lab"
sidebar_position: 1
---
...
It has concrete `kubectl` commands, Kubernetes-only examples, and a linear Track C path
from Module 7 through Module 10. Use it instead of this unified version.
:::

:::important Track Selection
Choose your track now and stay with it through Module 8.
...
:::info Track C (Kubernetes) — additional setup
