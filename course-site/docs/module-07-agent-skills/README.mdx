...
:::info Lab Location
The hands-on lab for this module lives in the **Hermes repository**. This page covers the conceptual foundation you need before running the lab. Read the [Concepts](./reading/concepts.mdx) and [Reference](./reading/reference.mdx) pages first, then open the Hermes lab guide.
:::
