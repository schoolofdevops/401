...
> **Before you proceed:** make a backup of your working config so you can restore it in Step 14.
>
> ```bash
...
> **Teaching moment: the wrapper_allowlist diff**
>
...
> **Solo Learner (Udemy self-paced):** Keep the above block in a scratchpad file like `~/.lab-env` and source it at the start of each terminal session: `source ~/.lab-env`. This avoids retyping the 6 exports every time. All 6 vars must be set for the wrapper enforcement to function correctly.
...
> **Teaching callout: what L4 means**
>
