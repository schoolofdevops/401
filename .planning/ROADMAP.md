...
- [x] 11-02-PLAN.md — Cross-reference updates in Modules 1, 4, 8, 10, 14, resources, intro.mdx, and CLAUDE.md tool split table
...
**Plans:** 2/2 plans complete
Plans:
- [x] 12-01-PLAN.md — Create LAB-track-c-kubernetes.mdx with all 5 trigger types (cron, AlertManager, CronJob, GitHub, Telegram) using real KIND infrastructure
- [x] 12-02-PLAN.md — Update README.mdx with Track C lab reference, track-aware prerequisites (Module 8 + KIND for Track C)
